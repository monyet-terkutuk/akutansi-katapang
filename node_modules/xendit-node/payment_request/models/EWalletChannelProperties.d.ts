 ...
 */
export declare function instanceOfEWalletChannelProperties(value: object): boolean;
export declare function EWalletChannelPropertiesFromJSON(json: any): EWalletChannelProperties;
export declare function EWalletChannelPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EWalletChannelProperties;
export declare function EWalletChannelPropertiesToJSON(value?: EWalletChannelProperties | null): any;
