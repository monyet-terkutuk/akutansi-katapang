 ...
 * @export
 */
export declare const EWalletChannelCode: {
    ...
    readonly Touchandgo: "TOUCHANDGO";
...
export declare function EWalletChannelCodeFromJSON(json: any): EWalletChannelCode;
export declare function EWalletChannelCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EWalletChannelCode;
export declare function EWalletChannelCodeToJSON(value?: EWalletChannelCode | null): any;
